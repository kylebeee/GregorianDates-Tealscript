...
import { GregorianDatesClient } from '../contracts/clients/GregorianDatesClient';

const fixture = algorandFixture();
algokit.Config.configure({ populateAppCallResources: true });

let appClient: GregorianDatesClient;

describe('GregorianDates', () => {
  ...
  beforeAll(async () => {
    ...
    appClient = new GregorianDatesClient(
      {
        sender: testAccount,
        resolveBy: 'id',
        id: 0,
